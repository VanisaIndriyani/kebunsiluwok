...
// Handle Filters
$where_clauses = ["t.jenis_transaksi = 'keluar'"];
$params = [];
...
if (isset($_GET['bulan']) && !empty($_GET['bulan'])) {
    ...
    $stmt_max = $koneksi->query("SELECT MAX(tanggal) FROM transaksi_gudang WHERE jenis_transaksi = 'keluar'");
...
<head>
    ...
    <title>Stok Keluar - PTPN I Regional 3</title>
    <!-- Bootstrap 5 -->
...
<body>
    ...
    <div class="sidebar">
        ...
        <ul class="sidebar-menu">
            ...
            <li><a href="stok_keluar.php" class="active"><i class="fas fa-arrow-up"></i> Stok Keluar</a></li>
            <li>
    ...
    <div class="main-content">
        ...
        <div class="welcome-banner mb-4">
            <div class="row align-items-center">
                <div class="col-md-8">
                    <h4 class="mb-1 text-white">Laporan Stok Keluar</h4>
                    <p class="mb-0 text-white-50">Monitoring pengeluaran barang dan pemakaian kebun.</p>
                </div>
                <div class="col-md-4 text-end d-none d-md-block">
                    <i class="fas fa-arrow-up fa-3x text-white opacity-25"></i>
                </div>
            </div>
        </div>
            ...
            <div class="col-md-4">
                <div class="card card-gradient-orange text-white h-100 border-0 shadow-sm">
                    <div class="card-body p-3">
                        <div class="d-flex justify-content-between align-items-start">
                            <div>
                                <span class="info-detail-label">Total Barang Keluar</span>
                                <span class="info-detail-value"><?php echo number_format($total_qty, 2); ?></span>
                                <div class="mt-1 small opacity-75">Unit / Kg / Liter</div>
                            </div>
                            <i class="fas fa-dolly fa-2x opacity-25"></i>
                        </div>
                    </div>
                </div>
            </div>
            <div class="col-md-4">
                <div class="card card-gradient-purple text-white h-100 border-0 shadow-sm">
                    <div class="card-body p-3">
                        <div class="d-flex justify-content-between align-items-start">
                            <div>
                                ...
                                <div class="mt-1 small opacity-75"><?php echo number_format($top_qty, 2); ?> Keluar</div>
                            </div>
                ...
                <form method="GET" class="row g-3 align-items-end">
                    ...
                    <div class="col-md-5 text-md-end">
                        <div class="btn-group shadow-sm">
                            <a href="export_keluar.php?afdeling=<?php echo isset($_GET['afdeling']) ? $_GET['afdeling'] : ''; ?>&bulan=<?php echo $selected_bulan; ?>&type=pdf" target="_blank" class="btn btn-light text-danger fw-bold">
                                <i class="fas fa-print me-1"></i> Print
                            </a>
                            <a href="export_keluar.php?afdeling=<?php echo isset($_GET['afdeling']) ? $_GET['afdeling'] : ''; ?>&bulan=<?php echo $selected_bulan; ?>&type=excel" target="_blank" class="btn btn-light text-danger fw-bold">
        ...
        <div class="card table-card border-0 shadow-sm">
            <div class="card-header bg-white border-0 py-3">
                <h6 class="m-0 fw-bold text-danger"><i class="fas fa-list me-2"></i>Rincian Stok Keluar - <?php echo date('F Y', strtotime($selected_bulan)); ?></h6>
            </div>
            <div class="card-body p-0">
                <div class="table-responsive">
                    <table id="stokKeluarTable" class="table table-hover align-middle mb-0">
                        <thead class="bg-light">
                            <tr>
                                ...
                                <th class="text-end py-3 text-secondary text-uppercase small fw-bold border-0">Jumlah Keluar</th>
                            </tr>
                        </thead>
                        <tbody>
                            <?php if (count($transaksi) > 0): ?>
                                ...
                                <tr>
                                    ...
                                    <td><span class="badge bg-warning bg-opacity-10 text-warning"><?php echo $row['kategori']; ?></span></td>
                                    <td class="text-center text-muted"><?php echo $row['satuan']; ?></td>
                                    <td class="text-end fw-bold text-danger"><?php echo number_format($row['jumlah'], 2, ',', '.'); ?></td>
                                </tr>
                                <?php endforeach; ?>
                            <?php else: ?>
                                <tr>
                                    <td colspan="7" class="text-center py-5">
                                        <div class="text-muted">
                                            ...
                                            <p class="mb-0">Tidak ada data stok keluar pada periode ini.</p>
                                        </div>
                                    </td>
                                </tr>
                            <?php endif; ?>
                        ...
                        <tfoot class="bg-light fw-bold">
                            <tr>
                                <td colspan="6" class="text-end text-secondary text-uppercase py-3">Total Keluar</td>
                                <td class="text-end text-danger py-3 fs-6"><?php echo number_format($total_qty, 2, ',', '.'); ?></td>
                            </tr>
                        </tfoot>
                    </table>
                </div>
