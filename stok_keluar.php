...
<body>
    ...
    <div class="main-content">
        ...
        <div class="top-navbar animate-fade-in">
            <div class="d-flex align-items-center">
                ...
                <div class="d-none d-md-block">
                    <h5 class="m-0 fw-bold text-danger">Laporan Stok Keluar</h5>
                    <p class="m-0 text-muted" style="font-size: 0.85rem;">Monitoring pengeluaran barang dan pemakaian kebun</p>
                </div>
            </div>
        ...
        <!-- Welcome Banner -->
        <div class="welcome-banner animate-fade-in delay-1 mb-4" style="background: linear-gradient(135deg, #FF512F 0%, #DD2476 100%);">
            <div class="row align-items-center">
                <div class="col-md-8">
                    <h4 class="fw-bold mb-2 text-white">Stok Keluar & Pemakaian</h4>
                    <p class="mb-0 text-white-50">Rekapitulasi pengeluaran barang dari gudang.</p>
                </div>
        ...
        <div class="row g-3 mb-4">
            ...
            <div class="col-md-4 animate-fade-in delay-2">
                <div class="stats-card bg-gradient-3">
                    <div class="stats-icon"><i class="fas fa-dolly"></i></div>
                    <div class="stats-label">Total Barang Keluar</div>
            ...
            <div class="col-md-4 animate-fade-in delay-2">
                <div class="stats-card bg-gradient-2">
                    ...
                    <div style="font-size: 0.85rem; opacity: 0.8;"><?php echo number_format($top_qty, 0); ?> Unit Keluar</div>
                </div>
            </div>
        </div>
        ...
        <div class="glass-card animate-fade-in delay-3">
            ...
            <form method="GET" class="row g-3">
                ...
                <div class="col-md-5 d-flex align-items-center justify-content-end gap-2">
                     <a href="export_keluar.php?afdeling=<?php echo isset($_GET['afdeling']) ? $_GET['afdeling'] : ''; ?>&bulan=<?php echo $selected_bulan; ?>&type=excel" target="_blank" class="btn btn-success rounded-pill px-4 py-2 fw-bold">
                        <i class="fas fa-file-excel me-2"></i> Excel
                    </a>
                    <a href="export_keluar.php?afdeling=<?php echo isset($_GET['afdeling']) ? $_GET['afdeling'] : ''; ?>&bulan=<?php echo $selected_bulan; ?>&type=pdf" target="_blank" class="btn btn-danger rounded-pill px-4 py-2 fw-bold">
        ...
        <div class="glass-card animate-fade-in delay-4">
            <div class="section-title mb-4">
                <i class="fas fa-list"></i> Rincian Stok Keluar
            </div>
            <div class="table-responsive">
                <table class="table table-hover align-middle">
                    ...
                    <tbody>
                        <?php if (count($transaksi) > 0): ?>
                            ...
                            <tr>
                                ...
                                <td class="fw-bold text-danger"><?php echo $row['nama_barang']; ?></td>
                                <td><span class="badge bg-warning bg-opacity-10 text-warning border border-warning"><?php echo $row['kategori']; ?></span></td>
                    ...
                    <tfoot class="bg-light fw-bold">
                        <tr>
                            <td colspan="6" class="text-end text-uppercase py-3">Total Keluar</td>
                            <td class="text-end text-danger py-3 fs-6"><?php echo number_format($total_qty, 0, ',', '.'); ?></td>
                        </tr>
                    </tfoot>
                </table>
            </div>
